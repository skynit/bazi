...
var yearZhiShenShaRules = map[string][]shenShaRule{
	"子": {{"丧门", "寅"}, {"吊客", "戌"}, {"病符", "亥"}, {"死符", "巳"}, {"官符", "辰"}, {"大耗", "午"}, {"小耗", "戌"}, {"宅煞", "丑"}, {"白虎", "申"}, {"飞廉", "巳"}, {"的煞", "亥"}, {"灾煞", "午"}},
	"丑": {{"丧门", "卯"}, {"吊客", "亥"}, {"病符", "子"}, {"死符", "午"}, {"官符", "巳"}, {"大耗", "未"}, {"小耗", "亥"}, {"宅煞", "寅"}, {"白虎", "酉"}, {"飞廉", "午"}, {"的煞", "子"}, {"灾煞", "卯"}},
	"寅": {{"丧门", "辰"}, {"吊客", "子"}, {"病符", "丑"}, {"死符", "未"}, {"官符", "午"}, {"大耗", "申"}, {"小耗", "子"}, {"宅煞", "卯"}, {"白虎", "戌"}, {"飞廉", "未"}, {"的煞", "丑"}, {"灾煞", "子"}},
	"卯": {{"丧门", "巳"}, {"吊客", "丑"}, {"病符", "寅"}, {"死符", "申"}, {"官符", "未"}, {"大耗", "酉"}, {"小耗", "丑"}, {"宅煞", "辰"}, {"白虎", "亥"}, {"飞廉", "申"}, {"的煞", "寅"}, {"灾煞", "酉"}},
	"辰": {{"丧门", "午"}, {"吊客", "寅"}, {"病符", "卯"}, {"死符", "酉"}, {"官符", "申"}, {"大耗", "戌"}, {"小耗", "寅"}, {"宅煞", "巳"}, {"白虎", "子"}, {"飞廉", "酉"}, {"的煞", "卯"}, {"灾煞", "午"}},
	"巳": {{"丧门", "未"}, {"吊客", "卯"}, {"病符", "辰"}, {"死符", "戌"}, {"官符", "酉"}, {"大耗", "亥"}, {"小耗", "卯"}, {"宅煞", "午"}, {"白虎", "丑"}, {"飞廉", "戌"}, {"的煞", "辰"}, {"灾煞", "卯"}},
	"午": {{"丧门", "申"}, {"吊客", "辰"}, {"病符", "巳"}, {"死符", "亥"}, {"官符", "戌"}, {"大耗", "子"}, {"小耗", "辰"}, {"宅煞", "未"}, {"白虎", "寅"}, {"飞廉", "亥"}, {"的煞", "巳"}, {"灾煞", "子"}},
	"未": {{"丧门", "酉"}, {"吊客", "巳"}, {"病符", "午"}, {"死符", "子"}, {"官符", "亥"}, {"大耗", "丑"}, {"小耗", "巳"}, {"宅煞", "申"}, {"白虎", "卯"}, {"飞廉", "子"}, {"的煞", "午"}, {"灾煞", "酉"}},
	"申": {{"丧门", "戌"}, {"吊客", "午"}, {"病符", "未"}, {"死符", "丑"}, {"官符", "子"}, {"大耗", "寅"}, {"小耗", "午"}, {"宅煞", "酉"}, {"白虎", "辰"}, {"飞廉", "丑"}, {"的煞", "未"}, {"灾煞", "午"}},
	"酉": {{"丧门", "亥"}, {"吊客", "未"}, {"病符", "申"}, {"死符", "寅"}, {"官符", "丑"}, {"大耗", "卯"}, {"小耗", "未"}, {"宅煞", "戌"}, {"白虎", "巳"}, {"飞廉", "寅"}, {"的煞", "申"}, {"灾煞", "卯"}},
	"戌": {{"丧门", "子"}, {"吊客", "申"}, {"病符", "酉"}, {"死符", "卯"}, {"官符", "寅"}, {"大耗", "辰"}, {"小耗", "申"}, {"宅煞", "亥"}, {"白虎", "午"}, {"飞廉", "卯"}, {"的煞", "酉"}, {"灾煞", "子"}},
	"亥": {{"丧门", "丑"}, {"吊客", "酉"}, {"病符", "戌"}, {"死符", "辰"}, {"官符", "卯"}, {"大耗", "巳"}, {"小耗", "酉"}, {"宅煞", "子"}, {"白虎", "未"}, {"飞廉", "辰"}, {"的煞", "戌"}, {"灾煞", "酉"}},
}
...
var monthZhiShenShaRules = map[string][]shenShaRule{
	"子": {{"天刑", "亥"}, {"飞廉", "寅"}, {"天火", "午"}, {"天贼", "巳"}, {"月煞", "未"}, {"月刑", "卯"}, {"月害", "未"}, {"月厌", "子"}, {"大时", "酉"}, {"兵禁", "申"}, {"天吏", "午"}, {"致死", "亥"}},
	"丑": {{"天刑", "子"}, {"飞廉", "酉"}, {"天火", "酉"}, {"天贼", "午"}, {"月煞", "申"}, {"月刑", "戌"}, {"月害", "午"}, {"月厌", "亥"}, {"大时", "午"}, {"兵禁", "亥"}, {"天吏", "卯"}, {"致死", "寅"}},
	"寅": {{"天刑", "寅"}, {"飞廉", "戌"}, {"天火", "子"}, {"天贼", "未"}, {"月煞", "戌"}, {"月刑", "巳"}, {"月害", "巳"}, {"月厌", "戌"}, {"大时", "卯"}, {"兵禁", "寅"}, {"天吏", "子"}, {"致死", "巳"}},
	"卯": {{"天刑", "卯"}, {"飞廉", "巳"}, {"天火", "卯"}, {"天贼", "申"}, {"月煞", "酉"}, {"月刑", "子"}, {"月害", "辰"}, {"月厌", "酉"}, {"大时", "子"}, {"兵禁", "巳"}, {"天吏", "酉"}, {"致死", "申"}},
	"辰": {{"天刑", "辰"}, {"飞廉", "午"}, {"天火", "午"}, {"天贼", "酉"}, {"月煞", "申"}, {"月刑", "辰"}, {"月害", "卯"}, {"月厌", "申"}, {"大时", "酉"}, {"兵禁", "申"}, {"天吏", "午"}, {"致死", "亥"}},
	"巳": {{"天刑", "巳"}, {"飞廉", "未"}, {"天火", "酉"}, {"天贼", "戌"}, {"月煞", "未"}, {"月刑", "申"}, {"月害", "寅"}, {"月厌", "未"}, {"大时", "午"}, {"兵禁", "亥"}, {"天吏", "卯"}, {"致死", "寅"}},
	"午": {{"天刑", "午"}, {"飞廉", "申"}, {"天火", "子"}, {"天贼", "亥"}, {"月煞", "午"}, {"月刑", "午"}, {"月害", "丑"}, {"月厌", "午"}, {"大时", "卯"}, {"兵禁", "寅"}, {"天吏", "子"}, {"致死", "巳"}},
	"未": {{"天刑", "未"}, {"飞廉", "酉"}, {"天火", "卯"}, {"天贼", "子"}, {"月煞", "巳"}, {"月刑", "丑"}, {"月害", "子"}, {"月厌", "巳"}, {"大时", "子"}, {"兵禁", "巳"}, {"天吏", "酉"}, {"致死", "申"}},
	"申": {{"天刑", "申"}, {"飞廉", "戌"}, {"天火", "午"}, {"天贼", "丑"}, {"月煞", "辰"}, {"月刑", "寅"}, {"月害", "亥"}, {"月厌", "辰"}, {"大时", "酉"}, {"兵禁", "申"}, {"天吏", "午"}, {"致死", "亥"}},
	"酉": {{"天刑", "酉"}, {"飞廉", "亥"}, {"天火", "酉"}, {"天贼", "寅"}, {"月煞", "卯"}, {"月刑", "酉"}, {"月害", "戌"}, {"月厌", "卯"}, {"大时", "午"}, {"兵禁", "亥"}, {"天吏", "卯"}, {"致死", "寅"}},
	"戌": {{"天刑", "戌"}, {"飞廉", "子"}, {"天火", "子"}, {"天贼", "卯"}, {"月煞", "寅"}, {"月刑", "未"}, {"月害", "酉"}, {"月厌", "寅"}, {"大时", "卯"}, {"兵禁", "寅"}, {"天吏", "子"}, {"致死", "巳"}},
	"亥": {{"天刑", "亥"}, {"飞廉", "丑"}, {"天火", "卯"}, {"天贼", "辰"}, {"月煞", "丑"}, {"月刑", "亥"}, {"月害", "申"}, {"月厌", "丑"}, {"大时", "子"}, {"兵禁", "巳"}, {"天吏", "酉"}, {"致死", "申"}},
}

// 日干神煞：福星贵人按经典口诀（甲寅乙丑丙寅丁亥戊申己未庚午辛巳壬辰癸卯）
// 天乙贵人保留供时贵等查用（年干日干同源）
var dayGanShenShaRules = map[string][]shenShaRule{
	...
	// 经典依据：渊海子平，阴干无羊刃（"五阳干有刃五阴干无刃"），删除乙之羊刃
	// 经典依据：福星贵人口诀"甲寅乙丑丙寅丁亥"，乙福星在丑
	"乙": {{"禄神", "卯"}, {"金舆", "巳"}, {"红艳煞", "申"}, {"文昌贵人", "午"}, {"学堂", "午"}, {"词馆", "卯"}, {"天厨食禄", "午"}, {"福星贵人", "丑"}, {"国印贵人", "亥"}, {"天官", "辰"}, {"天乙贵人", "子申"}, {"太极贵人", "子午"}},
	// 经典依据：福星贵人口诀"甲寅乙丑丙寅丁亥"，丙福星在寅
	"丙": {{"禄神", "巳"}, {"羊刃", "午"}, {"金舆", "未"}, {"红艳煞", "寅"}, {"文昌贵人", "申"}, {"学堂", "寅"}, {"词馆", "巳"}, {"天厨食禄", "巳"}, {"福星贵人", "寅"}, {"国印贵人", "丑"}, {"天官", "巳"}, {"天乙贵人", "亥酉"}, {"太极贵人", "卯酉"}},
	// 经典依据：渊海子平，阴干无羊刃（"五阳干有刃五阴干无刃"），删除丁之羊刃
	// 经典依据：福星贵人口诀"甲寅乙丑丙寅丁亥"，丁福星在亥
	"丁": {{"禄神", "午"}, {"金舆", "申"}, {"红艳煞", "未"}, {"文昌贵人", "酉"}, {"学堂", "酉"}, {"词馆", "午"}, {"天厨食禄", "午"}, {"福星贵人", "亥"}, {"国印贵人", "寅"}, {"天官", "酉"}, {"天乙贵人", "亥酉"}, {"太极贵人", "卯酉"}},
	"戊": {{"禄神", "巳"}, {"羊刃", "午"}, {"金舆", "未"}, {"红艳煞", "辰"}, {"文昌贵人", "申"}, {"学堂", "申"}, {"词馆", "巳"}, {"天厨食禄", "申"}, {"福星贵人", "申"}, {"国印贵人", "丑"}, {"天官", "戌"}, {"天乙贵人", "丑未"}, {"太极贵人", "辰戌"}},
	// 经典依据：渊海子平，阴干无羊刃（"五阳干有刃五阴干无刃"），删除己之羊刃
	"己": {{"禄神", "午"}, {"金舆", "申"}, {"红艳煞", "辰"}, {"文昌贵人", "酉"}, {"学堂", "酉"}, {"词馆", "午"}, {"天厨食禄", "酉"}, {"福星贵人", "未"}, {"国印贵人", "寅"}, {"天官", "卯"}, {"天乙贵人", "子申"}, {"太极贵人", "辰戌"}},
	"庚": {{"禄神", "申"}, {"羊刃", "酉"}, {"金舆", "戌"}, {"红艳煞", "戌"}, {"文昌贵人", "亥"}, {"学堂", "巳"}, {"词馆", "申"}, {"天厨食禄", "亥"}, {"福星贵人", "午"}, {"国印贵人", "辰"}, {"天官", "亥"}, {"天乙贵人", "丑未"}, {"太极贵人", "寅申"}},
	// 经典依据：渊海子平，阴干无羊刃（"五阳干有刃五阴干无刃"），删除辛之羊刃
	"辛": {{"禄神", "酉"}, {"金舆", "亥"}, {"红艳煞", "酉"}, {"文昌贵人", "子"}, {"学堂", "子"}, {"词馆", "酉"}, {"天厨食禄", "子"}, {"福星贵人", "巳"}, {"国印贵人", "巳"}, {"天官", "申"}, {"天乙贵人", "寅午"}, {"太极贵人", "寅申"}},
	"壬": {{"禄神", "亥"}, {"羊刃", "子"}, {"金舆", "丑"}, {"红艳煞", "子"}, {"文昌贵人", "寅"}, {"学堂", "申"}, {"词馆", "亥"}, {"天厨食禄", "寅"}, {"福星贵人", "辰"}, {"国印贵人", "未"}, {"天官", "丑"}, {"天乙贵人", "卯巳"}, {"太极贵人", "巳亥"}},
	// 经典依据：渊海子平，阴干无羊刃（"五阳干有刃五阴干无刃"），删除癸之羊刃
	"癸": {{"禄神", "子"}, {"金舆", "寅"}, {"红艳煞", "申"}, {"文昌贵人", "卯"}, {"学堂", "卯"}, {"词馆", "子"}, {"天厨食禄", "卯"}, {"福星贵人", "卯"}, {"国印贵人", "申"}, {"天官", "子"}, {"天乙贵人", "卯巳"}, {"太极贵人", "巳亥"}},
}
...
var specialDayShenShaRules = map[string][]string{
	"戊子": {"九丑日", "阴差阳错", "六秀日", "阳煞"}, "戊午": {"九丑日", "孤鸾煞", "阴差阳错", "六秀日", "羊刃", "十灵日", "阳煞"},
	"壬子": {"九丑日", "孤鸾煞", "羊刃", "阳煞"}, "壬午": {"九丑日", "阳煞"}, "乙卯": {"九丑日", "八专", "福德秀气", "阴煞"}, "乙酉": {"福德秀气", "阴煞"},
	"辛卯": {"九丑日", "阴差阳错", "阴煞"}, "辛酉": {"九丑日", "阴差阳错", "八专", "六秀日", "阴煞"}, "己卯": {"九丑日", "阴煞"}, "己酉": {"九丑日", "阴煞"},
	"甲辰": {"十恶大败", "十灵日"}, "乙巳": {"十恶大败", "孤鸾煞", "福德秀气"}, "丙申": {"十恶大败", "阳煞"}, "丁亥": {"十恶大败"},
	"戊戌": {"十恶大败", "魁罡", "八专"}, "庚辰": {"十恶大败", "魁罡", "日德"}, "辛巳": {"十恶大败"}, "壬申": {"十恶大败", "阳煞"}, "癸亥": {"十恶大败", "阴差阳错"},
	"壬辰": {"魁罡", "阴差阳错"}, "庚戌": {"魁罡", "八专", "十灵日"}, "甲寅": {"孤鸾煞", "八专", "日德", "阳煞"}, "丙午": {"阴差阳错", "孤鸾煞", "六秀日", "羊刃"},
	"甲子": {"阳煞"}, "甲午": {"阳煞"}, "甲申": {"阳煞"}, "丙寅": {"阳煞"},
	"乙未": {"阴煞"}, "丁卯": {"阴煞"}, "癸卯": {"阴煞"},
	"丁巳": {"孤鸾煞"}, "辛亥": {"孤鸾煞", "十灵日"}, "戊申": {"阴差阳错", "孤鸾煞", "阳煞"}, "丙子": {"阴差阳错", "六秀日"},
	"丁丑": {"阴差阳错", "六秀日"}, "戊寅": {"阴差阳错", "阳煞"}, "癸巳": {"阴差阳错"}, "丁未": {"阴差阳错", "八专", "六秀日"}, "壬戌": {"阴差阳错", "日德"},
	"己未": {"八专", "六秀日", "羊刃"}, "庚申": {"八专", "词馆", "阳煞"}, "癸丑": {"八专", "羊刃"}, "乙丑": {"金神", "福德秀气", "阴煞"}, "己巳": {"金神"}, "癸酉": {"金神", "阴煞"},
	"丙辰": {"日德", "十灵日"}, "戊辰": {"日德"}, "己丑": {"十恶大败", "六秀日"}, "乙亥": {"十灵日"}, "丁酉": {"十灵日", "阴煞"}, "庚寅": {"十灵日", "阳煞"}, "壬寅": {"十灵日", "阳煞"}, "癸未": {"十灵日"},
}
...
// --- 科名：年干取 ---
var keMingByGan = map[string]string{
	"甲": "丑", "乙": "子", "丙": "亥", "丁": "戌", "戊": "酉",
	"己": "申", "庚": "未", "辛": "午", "壬": "巳", "癸": "辰",
}

// --- 文星：年干取 ---
var wenXingByGan = map[string]string{
	"甲": "巳", "乙": "午", "丙": "未", "丁": "申", "戊": "酉",
	"己": "戌", "庚": "亥", "辛": "子", "壬": "丑", "癸": "寅",
}

// --- 魁星：年干取 ---
var kuiXingByGan = map[string]string{
	"甲": "寅", "乙": "卯", "丙": "辰", "丁": "巳", "戊": "午",
	"己": "未", "庚": "申", "辛": "酉", "壬": "戌", "癸": "亥",
}
...
// --- 天医：月支前一位 ---
var tianYiByMonthZhi = map[string]string{
	"寅": "丑", "卯": "寅", "辰": "卯", "巳": "辰",
	"午": "巳", "未": "午", "申": "未", "酉": "申",
	"戌": "酉", "亥": "戌", "子": "亥", "丑": "子",
}
...
func addMonthGanRules(p ShenShaPillars, res *ShenShaCalcResult) {
	...
	// 天德合：天德在天干取干合，在地支取支合(六合)
	tianDeHe := ganHe[tianDe]
	if tianDeHe == "" {
		tianDeHe = zhiLiuHe[tianDe]
	}
	for _, target := range []struct {
		name string
		gan  string
	}{
		{"天德贵人", tianDe}, {"月德贵人", yueDe}, {"天德合", tianDeHe}, {"月德合", ganHe[yueDe]},
	} {
		if target.gan == "" {
			continue
		}
...
func addGlobalShenSha(p ShenShaPillars, res *ShenShaCalcResult) {
	...
	yearNayin := data.Nayin[data.GanIndex(p.Year.Gan)][data.ZhiIndex(p.Year.Zhi)]
	if entry := data.NaYinMap[yearNayin]; entry.Element == "火" {
		if p.Day.Zhi == "戌" || p.Day.Zhi == "亥" || p.Hour.Zhi == "戌" || p.Hour.Zhi == "亥" {
			appendShenSha(&res.Global, "天罗", "戌亥")
		}
	}
	if entry := data.NaYinMap[yearNayin]; entry.Element == "水" || entry.Element == "土" {
		if p.Day.Zhi == "辰" || p.Day.Zhi == "巳" || p.Hour.Zhi == "辰" || p.Hour.Zhi == "巳" {
			appendShenSha(&res.Global, "地网", "辰巳")
		}
	}
	if hasSpecialDay(p.Day.Gan+p.Day.Zhi, "金神") && (data.GanElement[p.Hour.Gan] == "火" || data.ZhiElement[p.Hour.Zhi] == "火") {
...
func addGongLuGongGui(p ShenShaPillars, res *ShenShaCalcResult) {
	...
	dIdx := data.ZhiIndex(p.Day.Zhi)
	hIdx := data.ZhiIndex(p.Hour.Zhi)
	if dIdx < 0 || hIdx < 0 {
		return
	}
	diff := hIdx - dIdx
	if diff == 2 || diff == -10 {
		middle := data.Zhis[(dIdx+1)%12]
...
func addLongDe(p ShenShaPillars, res *ShenShaCalcResult) {
	...
	if yRule.Jiang == dRule.Jiang && yRule.Jiang != "" {
		monthTianDe := data.MonthShenMap[data.TianDe][data.ZhiIndex(p.Month.Zhi)]
		if monthTianDe != "" {
...
func addYearZhiExtra(p ShenShaPillars, branches []string, res *ShenShaCalcResult) {
	...
	// 攀鞍：年支三合局墓库位（简化取法，与墓煞同源）
	if t := sanHeMuSha[p.Year.Zhi]; t != "" {
		checkAndAppend("攀鞍", t)
	}
	// 功曹：年支本位（简化取法）
	checkAndAppend("功曹", p.Year.Zhi)
	// 孤寡煞 = 孤辰+寡宿同时命中
	if guChenZhi := guChenBySanHui[p.Year.Zhi]; guChenZhi != "" {
		if guSuZhi := guSuBySanHui[p.Year.Zhi]; guSuZhi != "" {
...
func addYearGanExtra(p ShenShaPillars, branches []string, res *ShenShaCalcResult) {
	...
	// 岁驾：年干取禄位
	if t := luShenZhi[p.Year.Gan]; t != "" && branchInList(t, branches) {
		appendShenSha(&res.Year, "岁驾", t)
	}
	// 科名：年干取
	if t := keMingByGan[p.Year.Gan]; t != "" && branchInList(t, branches) {
		appendShenSha(&res.Year, "科名", t)
	}
	// 文星：年干取
	if t := wenXingByGan[p.Year.Gan]; t != "" && branchInList(t, branches) {
		appendShenSha(&res.Year, "文星", t)
	}
	// 魁星：年干取
	if t := kuiXingByGan[p.Year.Gan]; t != "" && branchInList(t, branches) {
		appendShenSha(&res.Year, "魁星", t)
	}
}
...
func addMonthZhiExtra(p ShenShaPillars, branches []string, res *ShenShaCalcResult) {
	...
	// 天医：月支前一位，落在哪柱加到哪柱
	if t := tianYiByMonthZhi[p.Month.Zhi]; t != "" {
		for i, zhi := range branches {
			if zhi == t {
				switch i {
				case 0:
					appendShenSha(&res.Year, "天医", t)
				case 1:
					appendShenSha(&res.Month, "天医", t)
				case 2:
					appendShenSha(&res.Day, "天医", t)
				case 3:
					appendShenSha(&res.Hour, "天医", t)
				}
			}
		}
	}
...
func addDayExtra(p ShenShaPillars, branches []string, res *ShenShaCalcResult) {
	// 飞刃：羊刃对冲（阳干有飞刃，阴干无）
	if feiRen := feiRenByGan[p.Day.Gan]; feiRen != "" && branchInList(feiRen, branches) {
		for i, zhi := range branches {
			if zhi == feiRen {
				switch i {
				case 0:
					appendShenSha(&res.Year, "飞刃", feiRen)
				case 1:
					appendShenSha(&res.Month, "飞刃", feiRen)
				case 2:
					appendShenSha(&res.Day, "飞刃", feiRen)
				case 3:
					appendShenSha(&res.Hour, "飞刃", feiRen)
				}
			}
		}
	}
	...
	if empty := siDaKongWang[p.Day.Gan+p.Day.Zhi]; empty != "" {
		for _, pillar := range []model.Pillar{p.Year, p.Month, p.Day, p.Hour} {
			...
			if entry := data.NaYinMap[naYin]; entry.Element == empty {
...
func addGenderBasedShenSha(p ShenShaPillars, branches []string, res *ShenShaCalcResult) {
	...
	front := data.Zhis[(chongIdx-1+12)%12] // 冲支前一位
	back := data.Zhis[(chongIdx+1)%12]     // 冲支后一位
