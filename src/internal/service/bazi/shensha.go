...
var yearGanShenShaRules = map[string][]shenShaRule{
	...
	"庚": {{"天乙贵人", "寅午"}, {"太极贵人", "寅申"}, {"流霞", "辰"}, {"血刃", "酉"}, {"血忌", "辰"}},
...
var monthZhiShenShaRules = map[string][]shenShaRule{
	"子": {{"天刑", "亥"}, {"飞廉", "寅"}, {"天火", "午"}, {"天贼", "午"}, {"月煞", "子"}, {"月刑", "卯"}, {"月害", "未"}, {"月厌", "子"}, {"大时", "酉"}, {"兵禁", "申"}, {"天吏", "卯"}, {"致死", "未"}},
	"丑": {{"天刑", "子"}, {"飞廉", "酉"}, {"天火", "酉"}, {"天贼", "巳"}, {"月煞", "亥"}, {"月刑", "戌"}, {"月害", "午"}, {"月厌", "亥"}, {"大时", "午"}, {"兵禁", "亥"}, {"天吏", "子"}, {"致死", "午"}},
	"寅": {{"天刑", "丑"}, {"飞廉", "戌"}, {"天火", "子"}, {"天贼", "辰"}, {"月煞", "戌"}, {"月刑", "巳"}, {"月害", "巳"}, {"月厌", "戌"}, {"大时", "卯"}, {"兵禁", "寅"}, {"天吏", "酉"}, {"致死", "巳"}},
	"卯": {{"天刑", "寅"}, {"飞廉", "巳"}, {"天火", "卯"}, {"天贼", "卯"}, {"月煞", "酉"}, {"月刑", "子"}, {"月害", "辰"}, {"月厌", "酉"}, {"大时", "子"}, {"兵禁", "巳"}, {"天吏", "午"}, {"致死", "辰"}},
	"辰": {{"天刑", "卯"}, {"飞廉", "午"}, {"天火", "午"}, {"天贼", "寅"}, {"月煞", "申"}, {"月刑", "辰"}, {"月害", "卯"}, {"月厌", "申"}, {"大时", "酉"}, {"兵禁", "申"}, {"天吏", "卯"}, {"致死", "卯"}},
	"巳": {{"天刑", "辰"}, {"飞廉", "未"}, {"天火", "酉"}, {"天贼", "丑"}, {"月煞", "未"}, {"月刑", "申"}, {"月害", "寅"}, {"月厌", "未"}, {"大时", "午"}, {"兵禁", "亥"}, {"天吏", "子"}, {"致死", "寅"}},
	"午": {{"天刑", "巳"}, {"飞廉", "申"}, {"天火", "子"}, {"天贼", "子"}, {"月煞", "午"}, {"月刑", "午"}, {"月害", "丑"}, {"月厌", "午"}, {"大时", "卯"}, {"兵禁", "寅"}, {"天吏", "卯"}, {"致死", "丑"}},
	"未": {{"天刑", "午"}, {"飞廉", "酉"}, {"天火", "卯"}, {"天贼", "亥"}, {"月煞", "巳"}, {"月刑", "丑"}, {"月害", "子"}, {"月厌", "巳"}, {"大时", "子"}, {"兵禁", "巳"}, {"天吏", "午"}, {"致死", "子"}},
	"申": {{"天刑", "未"}, {"飞廉", "戌"}, {"天火", "午"}, {"天贼", "戌"}, {"月煞", "辰"}, {"月刑", "寅"}, {"月害", "亥"}, {"月厌", "辰"}, {"大时", "酉"}, {"兵禁", "申"}, {"天吏", "酉"}, {"致死", "亥"}},
	"酉": {{"天刑", "申"}, {"飞廉", "亥"}, {"天火", "酉"}, {"天贼", "酉"}, {"月煞", "卯"}, {"月刑", "酉"}, {"月害", "戌"}, {"月厌", "卯"}, {"大时", "午"}, {"兵禁", "亥"}, {"天吏", "子"}, {"致死", "戌"}},
	"戌": {{"天刑", "酉"}, {"飞廉", "子"}, {"天火", "子"}, {"天贼", "申"}, {"月煞", "寅"}, {"月刑", "未"}, {"月害", "酉"}, {"月厌", "寅"}, {"大时", "卯"}, {"兵禁", "寅"}, {"天吏", "卯"}, {"致死", "酉"}},
	"亥": {{"天刑", "戌"}, {"飞廉", "丑"}, {"天火", "卯"}, {"天贼", "未"}, {"月煞", "丑"}, {"月刑", "亥"}, {"月害", "申"}, {"月厌", "丑"}, {"大时", "子"}, {"兵禁", "巳"}, {"天吏", "午"}, {"致死", "申"}},
}
...
var dayGanShenShaRules = map[string][]shenShaRule{
	...
	"乙": {{"禄神", "卯"}, {"羊刃", "寅"}, {"金舆", "巳"}, {"红艳煞", "申"}, {"文昌贵人", "午"}, {"学堂", "午"}, {"词馆", "卯"}, {"天厨食禄", "午"}, {"福星贵人", "丑"}, {"国印贵人", "亥"}, {"天官", "辰"}, {"天乙贵人", "子申"}, {"太极贵人", "子午"}},
	...
	"庚": {{"禄神", "申"}, {"羊刃", "酉"}, {"金舆", "戌"}, {"红艳煞", "戌"}, {"文昌贵人", "亥"}, {"学堂", "巳"}, {"词馆", "申"}, {"天厨食禄", "亥"}, {"福星贵人", "午"}, {"国印贵人", "辰"}, {"天官", "亥"}, {"天乙贵人", "寅午"}, {"太极贵人", "寅申"}},
...
var specialDayShenShaRules = map[string][]string{
	...
	"丙辰": {"日德", "十灵日"}, "戊辰": {"日德"}, "己丑": {"十恶大败", "六秀日"}, "乙亥": {"十灵日"}, "丁酉": {"十灵日"}, "庚寅": {"十灵日"}, "壬寅": {"十灵日"}, "癸未": {"十灵日"},
}
