...
var shenShaFullCases = []shenShaFullCase{
	...
	{ID: "SSF-001", Desc: "乙日天乙贵人在子申—年支子→年柱有贵人",
		...
		Asserts: []shenShaAssert{{"year", "天乙贵人"}}, Source: "渊海子平"},
	{ID: "SSF-002", Desc: "甲日天乙贵人丑未—时支未→时柱有时贵",
		YearP: "壬辰", MonP: "壬寅", DayP: "甲寅", HouP: "辛未", Gender: "MALE",
		Asserts: []shenShaAssert{{"hour", "时贵"}}, Source: "渊海子平"},
	{ID: "SSF-003", Desc: "辛日天乙贵人寅午—时支寅→时柱有时贵",
	...
	// ========== 太极贵人 ==========
	{ID: "SSF-010", Desc: "甲日太极贵人在子午—日支午→日柱有太极贵人",
		YearP: "壬辰", MonP: "壬寅", DayP: "甲午", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"day", "太极贵人"}}, Source: "渊海子平"},
	...
	{ID: "SSF-031", Desc: "壬刃在子—时柱子→时柱有时刃",
		YearP: "己酉", MonP: "乙丑", DayP: "壬戌", HouP: "庚子", Gender: "MALE",
		Asserts: []shenShaAssert{{"hour", "时刃"}},
		NegAsserts: []shenShaAssert{{"day", "羊刃"}}, Source: "渊海子平"},
	...
	{ID: "SSF-040", Desc: "甲日金舆在辰—日支寅非辰→日无",
		YearP: "壬辰", MonP: "壬寅", DayP: "甲寅", HouP: "庚午", Gender: "MALE",
		NegAsserts: []shenShaAssert{{"day", "金舆"}}, Source: "渊海子平"},
	{ID: "SSF-041", Desc: "乙日金舆在巳—乙巳日→日柱有金舆(日干乙,日支巳)",
		YearP: "癸酉", MonP: "甲子", DayP: "乙巳", HouP: "辛酉", Gender: "MALE",
		Asserts: []shenShaAssert{{"day", "金舆"}}, Source: "渊海子平"},

	// ========== 文昌贵人 ==========
	{ID: "SSF-050", Desc: "甲日文昌在巳—日支寅非巳,年支辰→无",
		YearP: "壬辰", MonP: "壬寅", DayP: "甲寅", HouP: "庚午", Gender: "MALE",
		NegAsserts: []shenShaAssert{{"day", "文昌贵人"}}, Source: "渊海子平"},
	{ID: "SSF-051", Desc: "乙日文昌在午—乙日寻地支午→时柱有文昌",
		YearP: "乙巳", MonP: "丙戌", DayP: "乙酉", HouP: "甲午", Gender: "MALE",
		Asserts: []shenShaAssert{{"hour", "文昌贵人"}}, Source: "渊海子平"},

	// ========== 福星贵人 ==========
	{ID: "SSF-060", Desc: "甲日福星在寅—月支寅→月柱有福星",
		YearP: "壬辰", MonP: "丙寅", DayP: "甲午", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"month", "福星贵人"}}, Source: "渊海子平"},
	...
	{ID: "SSF-090", Desc: "申子辰驿马在寅—全局无寅→无驿马",
		...
		NegAsserts: []shenShaAssert{{"day", "驿马"}, {"year", "驿马"}}, Source: "渊海子平"},
	{ID: "SSF-091", Desc: "亥卯未驿马在巳—年支巳→年柱有驿马",
		YearP: "乙巳", MonP: "戊寅", DayP: "己亥", HouP: "丙寅", Gender: "FEMALE",
		Asserts: []shenShaAssert{{"year", "驿马"}}, Source: "渊海子平"},

	// ========== 桃花 ==========
	{ID: "SSF-100", Desc: "亥卯未桃花在子—全局无子→无桃花",
		YearP: "乙亥", MonP: "戊寅", DayP: "己亥", HouP: "丙寅", Gender: "FEMALE",
		NegAsserts: []shenShaAssert{{"day", "桃花"}, {"year", "桃花"}}, Source: "渊海子平"},
	{ID: "SSF-101", Desc: "巳酉丑桃花在午—(日支酉)月支午→月柱有桃花",
		YearP: "癸酉", MonP: "戊午", DayP: "癸酉", HouP: "辛酉", Gender: "MALE",
		Asserts: []shenShaAssert{{"month", "桃花"}}, Source: "渊海子平"},

	// ========== 将星 ==========
	{ID: "SSF-110", Desc: "寅午戌将星在午—日支午→日柱有将星",
		YearP: "庚戌", MonP: "丙戌", DayP: "甲午", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"day", "将星"}}, Source: "渊海子平"},
	...
	{ID: "SSF-150", Desc: "申酉戌孤辰在亥—日支亥→日柱有孤辰",
		...
		Asserts: []shenShaAssert{{"day", "孤辰"}}, Source: "渊海子平"},
	{ID: "SSF-151", Desc: "寅卯辰寡宿在丑—月支丑→月柱有寡宿",
		YearP: "甲寅", MonP: "乙丑", DayP: "甲子", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"month", "寡宿"}}, Source: "渊海子平"},

	// ========== 天德/月德 ==========
	{ID: "SSF-160", Desc: "戌月天德在丙—丙戌月→月柱有天德月德",
		YearP: "庚戌", MonP: "丙戌", DayP: "甲寅", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"month", "天德"}, {"month", "月德"}}, Source: "渊海子平"},
	{ID: "SSF-161", Desc: "寅月天德在丁—全局无丁→无天德",
		YearP: "乙丑", MonP: "戊寅", DayP: "甲子", HouP: "丙寅", Gender: "MALE",
		NegAsserts: []shenShaAssert{{"month", "天德"}}, Source: "渊海子平"},

	// ========== 学堂 ==========
	{ID: "SSF-170", Desc: "甲日学堂在亥—时支亥→时柱有学堂",
		YearP: "壬辰", MonP: "壬寅", DayP: "甲寅", HouP: "乙亥", Gender: "MALE",
		Asserts: []shenShaAssert{{"hour", "学堂"}}, Source: "渊海子平"},

	// ========== 词馆 ==========
	{ID: "SSF-171", Desc: "甲日词馆在寅—月支寅→月柱有词馆",
		YearP: "壬辰", MonP: "丙寅", DayP: "甲午", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"month", "词馆"}}, Source: "渊海子平"},

	// ========== 天厨食禄 ==========
	{ID: "SSF-172", Desc: "甲日天厨食禄在巳—全局无巳→无",
		YearP: "壬辰", MonP: "壬寅", DayP: "甲寅", HouP: "庚午", Gender: "MALE",
		NegAsserts: []shenShaAssert{{"day", "天厨食禄"}}, Source: "渊海子平"},

	// ========== 国印贵人 ==========
	{ID: "SSF-173", Desc: "甲日国印在戌—全局无戌→无",
		YearP: "壬辰", MonP: "壬寅", DayP: "甲寅", HouP: "庚午", Gender: "MALE",
		NegAsserts: []shenShaAssert{{"day", "国印贵人"}}, Source: "渊海子平"},

	// ========== 天官 ==========
	{ID: "SSF-174", Desc: "甲日天官在未—全局无未→无",
		YearP: "壬辰", MonP: "壬寅", DayP: "甲午", HouP: "庚午", Gender: "MALE",
		NegAsserts: []shenShaAssert{{"month", "天官"}}, Source: "渊海子平"},

	// ========== 红鸾天喜 ==========
	{ID: "SSF-180", Desc: "年支酉红鸾在午→时支午→年柱有红鸾",
		YearP: "癸酉", MonP: "甲子", DayP: "癸亥", HouP: "戊午", Gender: "MALE",
		Asserts: []shenShaAssert{{"year", "红鸾"}}, Source: "渊海子平"},
	{ID: "SSF-181", Desc: "年支酉天喜在子→月支子→年柱有天喜",
		YearP: "癸酉", MonP: "甲子", DayP: "癸亥", HouP: "辛酉", Gender: "MALE",
		Asserts: []shenShaAssert{{"year", "天喜"}}, Source: "渊海子平"},
	...
	// ========== 三奇 ==========
	{ID: "SSF-220", Desc: "甲戊庚→天三奇",
		YearP: "甲辰", MonP: "戊辰", DayP: "庚申", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"global", "天三奇"}}, Source: "渊海子平"},
	{ID: "SSF-221", Desc: "乙丙丁→地三奇",
		YearP: "乙巳", MonP: "丙戌", DayP: "丁亥", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"global", "地三奇"}}, Source: "渊海子平"},

	// ========== 天罗地网 ==========
	{ID: "SSF-230", Desc: "年纳音火(丙寅炉中火)+日戌→天罗",
		YearP: "丙寅", MonP: "甲午", DayP: "甲戌", HouP: "乙亥", Gender: "MALE",
		Asserts: []shenShaAssert{{"global", "天罗"}}, Source: "渊海子平"},
	{ID: "SSF-231", Desc: "年纳音水土+日/时辰巳→地网",
		YearP: "壬辰", MonP: "壬寅", DayP: "甲辰", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"global", "地网"}}, Source: "渊海子平"},

	// ========== 龙虎拱命 ==========
	{ID: "SSF-240", Desc: "四柱有辰寅→龙虎拱命",
		YearP: "甲辰", MonP: "丙寅", DayP: "戊子", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"global", "龙虎拱命"}}, Source: "渊海子平"},

	// ========== 凤凰拱命 ==========
	{ID: "SSF-241", Desc: "四柱有酉巳→凤凰拱命",
		YearP: "乙酉", MonP: "辛巳", DayP: "甲子", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"global", "凤凰拱命"}}, Source: "渊海子平"},

	// ========== 红艳煞 ==========
	{ID: "SSF-250", Desc: "甲日红艳在午—日支午→日柱有红艳煞",
		YearP: "壬辰", MonP: "壬寅", DayP: "甲午", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"day", "红艳煞"}}, Source: "渊海子平"},
	...
	// ========== 十灵日 ==========
	{ID: "SSF-290", Desc: "甲辰日→十灵日",
		YearP: "甲辰", MonP: "丙寅", DayP: "甲辰", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"day", "十灵日"}}, Source: "渊海子平"},
	...
	// ========== 金神 ==========
	{ID: "SSF-320", Desc: "癸酉日→金神",
		YearP: "癸酉", MonP: "甲子", DayP: "癸酉", HouP: "辛酉", Gender: "MALE",
		Asserts: []shenShaAssert{{"day", "金神"}}, Source: "渊海子平"},

	// ========== 六秀日 ==========
	{ID: "SSF-330", Desc: "丙午日→六秀日",
		YearP: "丁未", MonP: "乙未", DayP: "丙午", HouP: "丁未", Gender: "FEMALE",
		Asserts: []shenShaAssert{{"day", "六秀日"}}, Source: "渊海子平"},
	...
	// ========== 元辰(性别相关) ==========
	{ID: "SSF-350", Desc: "阳男阴女取冲前→年支酉冲卯前一位寅→全局无寅→无元辰",
		YearP: "癸酉", MonP: "甲子", DayP: "癸亥", HouP: "辛酉", Gender: "MALE",
		NegAsserts: []shenShaAssert{{"year", "元辰"}}, Source: "渊海子平"},

	// ========== 天医 ==========
	{ID: "SSF-360", Desc: "寅月天医在丑—年支丑→年柱有天医",
		YearP: "乙丑", MonP: "戊寅", DayP: "甲子", HouP: "丙寅", Gender: "MALE",
		Asserts: []shenShaAssert{{"year", "天医"}}, Source: "渊海子平"},

	// ========== 流霞 ==========
	{ID: "SSF-370", Desc: "甲年流霞在酉—时支酉→时柱有流霞",
		YearP: "甲申", MonP: "丙寅", DayP: "甲子", HouP: "癸酉", Gender: "MALE",
		Asserts: []shenShaAssert{{"hour", "流霞"}}, Source: "渊海子平"},

	// ========== 隔角煞 ==========
	{ID: "SSF-380", Desc: "年支酉→隔角在戌—全局无戌→无",
		YearP: "癸酉", MonP: "甲子", DayP: "癸亥", HouP: "辛酉", Gender: "MALE",
		NegAsserts: []shenShaAssert{{"year", "隔角煞"}}, Source: "渊海子平"},

	// ========== 岁驾 ==========
	{ID: "SSF-390", Desc: "年干甲岁驾在寅—日支寅→年柱有岁驾",
		YearP: "甲辰", MonP: "丙寅", DayP: "甲寅", HouP: "庚午", Gender: "MALE",
		Asserts: []shenShaAssert{{"year", "岁驾"}}, Source: "渊海子平"},

	// ========== 童子煞 ==========
	{ID: "SSF-400", Desc: "巳月酉时→可能有童子煞",
		YearP: "乙巳", MonP: "辛巳", DayP: "甲子", HouP: "癸酉", Gender: "MALE",
		Source: "渊海子平"},
}
...
func TestShenShaFullCoverage(t *testing.T) {
	...
	total := pass + fail
	sb.WriteString(fmt.Sprintf("断言: %d通过 + %d失败 = %d总 | 准确率: %.1f%%\n", pass, fail, total, pctV3(pass, total)))
	...
	t.Log("\n" + sb.String())
	os.WriteFile("/tmp/bazi_shensha_full_report.txt", []byte(sb.String()), 0644)
