...
// Derived from iztro data/stars.ts brightness data.
var StarBrightnessMap = map[string][12]string{
	"紫微": {"旺", "旺", "旺", "得", "陷", "得", "庙", "旺", "旺", "平", "得", "旺"},
	"天机": {"得", "旺", "陷", "陷", "旺", "旺", "旺", "旺", "陷", "庙", "旺", "得"},
	"太阳": {"陷", "陷", "陷", "陷", "旺", "旺", "庙", "旺", "陷", "陷", "得", "得"},
	"武曲": {"庙", "得", "利", "陷", "旺", "利", "陷", "旺", "庙", "得", "得", "陷"},
	"天同": {"陷", "陷", "旺", "庙", "得", "陷", "陷", "旺", "旺", "陷", "利", "陷"},
	"廉贞": {"陷", "陷", "旺", "陷", "旺", "陷", "利", "利", "陷", "陷", "庙", "陷"},
	"天府": {"庙", "得", "陷", "庙", "得", "旺", "旺", "得", "陷", "庙", "得", "旺"},
	"太阴": {"陷", "陷", "陷", "陷", "旺", "旺", "旺", "旺", "陷", "陷", "庙", "得"},
	"贪狼": {"陷", "陷", "旺", "旺", "利", "陷", "陷", "旺", "陷", "陷", "庙", "陷"},
	"巨门": {"旺", "陷", "得", "得", "陷", "旺", "陷", "陷", "旺", "旺", "陷", "陷"},
	"天相": {"陷", "得", "陷", "陷", "庙", "旺", "旺", "旺", "得", "陷", "得", "得"},
	"天梁": {"陷", "旺", "陷", "利", "陷", "陷", "陷", "旺", "得", "陷", "庙", "旺"},
	"七杀": {"旺", "旺", "陷", "陷", "旺", "陷", "陷", "陷", "旺", "旺", "庙", "旺"},
	"破军": {"庙", "旺", "陷", "陷", "旺", "陷", "陷", "陷", "陷", "陷", "旺", "得"},
}

// AuxStarBrightnessMap maps auxiliary star names to brightness arrays.
// Only covers stars that have meaningful brightness levels.
var AuxStarBrightnessMap = map[string][12]string{
	"左辅": {"", "", "", "旺", "旺", "旺", "庙", "旺", "旺", "", "", "旺"},
	"右弼": {"旺", "", "", "旺", "旺", "旺", "", "旺", "旺", "庙", "", ""},
	"文昌": {"陷", "陷", "旺", "旺", "旺", "陷", "陷", "得", "旺", "旺", "庙", "陷"},
	"文曲": {"得", "陷", "陷", "旺", "旺", "陷", "陷", "庙", "旺", "旺", "得", "陷"},
	"天魁": {"旺", "", "旺", "", "旺", "", "旺", "", "旺", "", "庙", ""},
	"天钺": {"", "旺", "", "旺", "", "旺", "", "旺", "", "庙", "", "旺"},
	"禄存": {"", "旺", "庙", "", "", "", "", "旺", "庙", "", "", ""},
	"天马": {"", "", "", "", "", "", "", "", "", "", "", ""},
