...
// Iztro only provides brightness for 文昌、文曲、火星、铃星、擎羊、陀罗.
// Other auxiliary stars are retained with empty rows so lookups return no
// brightness instead of fabricating a level.
